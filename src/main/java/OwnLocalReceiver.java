...
public class OwnLocalReceiver implements VerificationCodeReceiver {
    ...
    public String getRedirectUri() throws IOException {
        ...
        return "http://" + this.getHost() + callbackPath;
    }
    ...
    public static final class Builder {
        ...
        public OwnLocalReceiver build() {
            return new OwnLocalReceiver(
